 ...
 *
 * File    : bg_animation.c
 * Desc    : Incorporates several elements related to the
 *           new flexible animation system.
 *           This includes scripting elements, support
 *           routines for new animation set reference
 *           system and other bits and pieces.
 *
 * Status  : Pending
 *
 *********************************************************/
