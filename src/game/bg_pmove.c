 ...
 *
 * File    : bg_pmove.c
 * Desc    : Both games player movement code.  Takes a
 *           playerstate and a usercmd as input and
 *           returns a modifed playerstate.
 *
 * Status  : Pending
 *
 *********************************************************/
...
// We want to store the groundtrace surface stuff,
